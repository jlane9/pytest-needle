...
project = u'pytest-needle'
copyright = u'2017, John Lane'
author = u'John Lane'
...
htmlhelp_basename = 'pytest-needledoc'
...
latex_documents = [
    (master_doc, 'pytest-needle.tex', u'pytest-needle Documentation',
     u'John Lane', 'manual'),
]
...
man_pages = [
    (master_doc, 'pytest-needle', u'pytest-needle Documentation',
     [author], 1)
]
